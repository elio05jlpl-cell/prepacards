...
copies qui défendent la même thèse n'obtiennent pas la même note. Ce qui les
sépare, presque toujours, ce sont les **repères** : la date exacte, le chiffre
juste, l'auteur cité à bon escient, l'étude de cas qui prouve au lieu
d'affirmer. Ces repères ne s'improvisent pas le jour de l'épreuve. Ils se
construisent sur deux ans, et c'est la partie du travail qui se prête le mieux
à une méthode.

## Ce que le correcteur attend vraiment

Une dissertation de géopolitique est une démonstration. Chaque idée doit être
**étayée**, et un argument sans exemple précis se lit comme une opinion. « La
Chine étend son influence en Afrique » ne vaut rien seul ; la même phrase suivie
d'un cas précis, daté et chiffré, devient un argument.
...
- **Les dates** : « Chute du mur de Berlin — 9 novembre 1989 ».
- **Les auteurs et leurs thèses** : « Auteur du *Choc des civilisations* —
  Samuel Huntington, article de 1993, livre de 1996 ».
- **Les notions**, avec leur origine : « *Soft power* — notion forgée par Joseph
  Nye ».
- **Les chiffres clés**, avec leur année et leur source.
- **Les études de cas**, réduites à leur point d'appui : le lieu, l'acteur, le
  fait qui prouve.
...
immédiatement : il répond à une autre question que celle du jour.

Les **croquis** et les cartes géographiques non plus. Ils se travaillent en les
refaisant, à main levée, jusqu'à pouvoir les reproduire de mémoire en dix
minutes. Une flashcard peut en garder un élément — la localisation d'un détroit,
le tracé d'une frontière —, pas le croquis lui-même.
...
première année peut être dépassé au concours.

D'où une règle stricte : **aucun chiffre sans son année**. Au verso, écrivez
toujours « … en 2024, selon telle source ». Deux avantages : vous savez quand le
vérifier à nouveau, et vous pouvez le citer honnêtement le jour J — « en 2024,
la part était de… » est irréprochable, même si elle a bougé depuis.

Une fois par semestre, repassez sur vos cartes chiffrées et mettez à jour
...
**Classer les cartes par thème du programme.** Une carte sur un détroit
stratégique peut servir à la fois sur les mers, sur le commerce et sur une
puissance donnée. Rangez-la là où elle vous sera le plus souvent utile, et
notez au verso les autres thèmes où elle peut servir.

**Rédiger des plans détaillés sans cours ouvert.** Une fois par semaine, prenez
...
PrépaCards fait revenir chaque repère au bon moment, sur les deux années, et
